...
chucky = User.create(username: "Chucky", password: "guest")
freddy = User.create(username: "Freddy", password: "guest")
hellraiser = User.create(username: "Hellraiser", password: "guest")
jason = User.create(username: "Jason", password: "guest")
ghostface = User.create(username: "Ghostface", password: "guest")
leatherface = User.create(username: "ChainsawManAggieFan", password: "guest")
